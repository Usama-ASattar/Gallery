...
/**
 * ActiveQuerySpace is used to query photo records.
 *
 * @since 1.4
 */
class ActiveQueryCommunity extends ActiveQuery
{
     ...
     */
    public function filterBlockedSpaces(?User $user = null): ActiveQueryCommunity
    {
        if ($user === null && !Yii::$app->user->isGuest) {
            $user = Yii::$app->user->getIdentity();
        }
